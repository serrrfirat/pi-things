...
1. Verify environment: `bash skill/scripts/sim_health_check.sh`
2. Launch app: `python skill/scripts/app_launcher.py --launch com.example.app`
3. Analyze screen: `python skill/scripts/screen_mapper.py`
4. Interact: `python skill/scripts/navigator.py --find-text "Button" --tap`
5. Verify: `python skill/scripts/accessibility_audit.py`
6. Debug if needed: `python skill/scripts/app_state_capture.py --app-bundle-id com.example.app`
