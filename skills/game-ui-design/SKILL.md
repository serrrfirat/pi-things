---
name: game-ui-design
description: Game UI design for HUDs, menus, inventories, controller navigation, diegetic interfaces, and cross-platform readability. Use when the user asks about game HUDs, health or stamina bars, minimaps, crosshairs, button prompts, radial menus, quest trackers, damage numbers, controller or touch navigation, accessibility in game interfaces, console or mobile game UX, or in-world UI patterns. Focus on clarity under action, immersion, safe zones, motion as communication, and layouts that work across keyboard, controller, and touch.
---
